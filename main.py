    ...
    if escolha == 1 or escolha == 2:
        ...
        if escolha == 1:
            if distancia < 10:
                ...
                print('\t   >> VICTORY!! <<')
                print('=' * 30)
                print(f'Sua distância até o alvo foi de {distancia}')
                break
        ...
        plt.show()
        if distancia < 100:
            print(f'Bahh!! Chegou perto! Sua distância é de {distancia} até o alvo.')
        elif distancia < 300:
            print(f'Ainda pode melhorar! Sua distância é de {distancia} até o alvo.')
        else:
            print(f'Ta muito frio ainda, mas tem chance! Sua distância é de {distancia} até o alvo.')
        if distancia < 2:
            plt.plot(posx, 10, 'ro')
            plt.show()
            print('=' * 30)
        ...
        if c == 5:
            ...
            break
        if distancia < 1:
            print('USAR HACK NÃO É PERMITIDO!')
# FIM DA REPETIÇÃO DE TENTATIVAS

# AO FINAL, fazer close() para fechar a janela
